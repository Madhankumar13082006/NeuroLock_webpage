...
const steps = [
  {
    ...
    description: "Choose which apps to track — Instagram, YouTube, TikTok, or any other. Set a daily time limit that feels right for you. No judgment, no defaults.",
  ...
  },
  {
    ...
    description: "When you reach your limit, NeuroLock gently intervenes — a brief pause screen, a PIN, or a reflective prompt. Not a wall. Just a moment.",
  ...
  },
  {
    ...
    description: "In that pause, you decide: continue with awareness, or step away. Either way, it was your choice. That moment of agency is what NeuroLock is built for.",
    color: "text-sky-400",
    glow: "bg-sky-900/20",
